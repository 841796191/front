    ...
    <validation-observer ref="observer" v-slot="{ validate }">
      <div class="layui-form-item">
        <validation-provider name="email" rules="required|email" v-slot="{errors}">
          ...
          <div class="layui-input-inline">
            <input type="text" id="L_email" name="email" class="layui-input" v-model="username">
          </div>
      ...
      <div class="layui-form-item">
        <validation-provider name="name" rules="required" v-slot="{errors}">
          ...
          <div class="layui-input-inline">
            <input type="text" v-model="name" id="L_username" name="username" class="layui-input">
          </div>
          <div class="layui-form-mid">
            <span style="color:#c00;">{{ errors[0] }}</span>
          </div>
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="text" v-model="location" id="L_city" name="city" class="layui-input">
        </div>
      </div>
      <div class="layui-form-item">
        <label for="L_gender"  class="layui-form-label">性别</label>
        <div class="layui-input-inline gray ml1" style="height:25px;line-height:25px;margin-top:7px;">
      ...
      <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
          <textarea v-model="regmark" placeholder="随便写些什么刷下存在感" id="L_sign" name="sign" class="layui-textarea"
